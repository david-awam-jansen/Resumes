...
\name{David Jansen} % To be used for the return address on the envelope
\signature{DJ} % Goes after the closing (ie at the end of the letter, with space for a signature)
